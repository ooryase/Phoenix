...
{
    class ChargeEffect : VirtualEffect
    {
        private float sheaderTop;
        private float sheaderBottom;
        private Vector3 sheaderRBG;

        public ChargeEffect(Battle battle, Renderer renderer, Sound sound, VirtualObject baseObj, Vector3 position)
        ...
        private void StateUpdate(int deltaTime)
        {
            ...
            sheaderRBG = new Vector3(1.0f, time / 500f, time / 1000f);
            effect.Parameters["RBG"].SetValue(sheaderRBG);
        }
